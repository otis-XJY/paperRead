...
setup(
    ...
    url='https://github.com/paperRead/paperRead',
    project_urls={
        'Bug Reports': 'https://github.com/otis-XJY/paperRead/issues',
        'Source': 'https://github.com/otis-XJY/paperRead',
        'Documentation': 'https://github.com/otis-XJY/paperRead/blob/main/README.md',
    },
